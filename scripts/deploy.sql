...
CALL SYSTEM$CREATE_SEMANTIC_VIEW_FROM_YAML(
  'DB_INSULINTEL.SCH_SEMANTIC',
  (SELECT $1 FROM @DB_INSULINTEL.SCH_SEMANTIC.REPO_SEMANTIC_MODELS/branches/main/semantic_views/sem_activity.yaml (FILE_FORMAT => 'DB_INSULINTEL.SCH_SEMANTIC.FF_YAML'))
);
